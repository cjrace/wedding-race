  ...
  return (
    <>
      ...
      <Text>
        ...
        RSVPs and the accomodation booking link is open, expected November 2025.
      </Text>

      <Space h="md" />
      <Title order={2}>How do I RSVP?</Title>
      <Text>
        An RSVP section will be added to the website once accomodation booking
      ...
      <Text>
        ...
        10pm as the venue request only guests staying on site remain after this
        time.
      </Text>
      ...
      <Space h="md" />
      <Title order={2}>
        I can&apos;t get there until the evening for the day before, is that
        okay?
      </Title>
      <Text>
      ...
      <Text>
        ...
        sure you&apos;re there before then. If you arrive early there&apos;ll be
        people around to point you in the right direction, and you will be able
        to wait with other guests in the wedding village. Note the bar
        won&apos;t be open until after the ceremony.
      </Text>
      ...
      <Text>
        ...
        too! There are bottle fridges available at the village to store drinks.
      </Text>
      ...
      <Text>
        Of course! We want you to feel comfortable and enjoy your stay so you
      ...
      <Text>
        For the wedding day food we&apos;ll collect dietary requirements as part
        of your RSVP. We&apos;ll then use this info to make sure we have
        suitable food and drinks for anyone staying in the wedding village the
        night before.
      </Text>

      <Space h="md" />
      <Title order={2}>What is included in the accommodation?</Title>
      <Text>
        ...
        you need it! There is self service tea and coffee in the Food Shack
        during your stay and breakfast is included.
      </Text>
      ...
      <Text>
        ...
        shouldn&apos;t be a problem but for somethign more socialble we have a
        dedicated makeup shack for beautifying yourself with company. For
        bridesmiads we&apos;ll be getting ready in the cottages, which has a
        separate room for make up and hair.
      </Text>
