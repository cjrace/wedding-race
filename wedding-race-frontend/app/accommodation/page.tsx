    ...
    <>
      ...
      <Grid>
        ...
        <Grid.Col span={4}>
          <iframe
            ...
            height="auto"
            width="100%"
            style={{ border: 0, maxWidth: '100%', height: 'auto', borderRadius: '10px' }}
            allowFullScreen
            loading="lazy"
      ...
      <Grid align="center">
        <Grid.Col span={7}>
          ...
          <Text>
            Pod options include twin, double, family and en-suite pods, some family pods can sleep 3 adults if needed.
          </Text>
          <Text>
            Booking for the pods will open late 2025, we&apos;ll reach out again to let you know when the link is open.
          </Text>
        </Grid.Col>
        <Grid.Col span={1}></Grid.Col>
        <Grid.Col span={4}>
