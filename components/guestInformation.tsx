  ...
  return (
    <section id="guest-information">
      ...
      <Text px={0}>
        ...
        information on the venue, the village, your itinerary, the chance to
        request songs and more!
      </Text>
      <Text px={0} mb="md">
      ...
      <Text px={0}>
        The bridal party will be wearing rust colours, and the grooms party will
        be in dark green and rust. There is no pressure to avoid these, though
        we&apos;re sharing as a few people have been asking already to help plan
        outfits!
      </Text>
      <Text px={0} mb="md">
      ...
      <Text px={0} mb="md">
        We will have Lola, and are expecting a handful of other 1-2 year olds at
        the celebrations. For the little ones, we will have dedicated
